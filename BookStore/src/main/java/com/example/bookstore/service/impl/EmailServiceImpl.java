...
public class EmailServiceImpl implements EmailService {
    ...
    private final String vLibraryEmail;

    public EmailServiceImpl(
            TemplateEngine templateEngine, JavaMailSender javaMailSender, @Value("${mail.bookStore}") String vLibraryEmail) {
        this.templateEngine = templateEngine;
        this.javaMailSender = javaMailSender;
        this.vLibraryEmail = vLibraryEmail;
    }
    ...
    public void sendRegistrationEmail(String userEmail, String userName, String activationCode)  {
        ...
        try {
            ...
            mimeMessageHelper.setFrom(vLibraryEmail);
            mimeMessageHelper.setReplyTo(vLibraryEmail);
            mimeMessageHelper.setSubject("Welcome to vLibrary!");
